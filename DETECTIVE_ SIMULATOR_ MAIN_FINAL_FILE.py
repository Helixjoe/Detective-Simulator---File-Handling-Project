            ...
            with open('score_board.csv', 'r') as file:
                ...
                for rec in rows:
                    if c == 0:
                        ...
                        modify_record_name = modify_record_name.replace(' ', '')
                        rec[2] = modify_record_name.lower().strip()
                        c1 = c1 + 1
...
def main():
    for i in range(167):
        print('*', end='')
    print()
    print('''                                                               WELCOME TO DETECTIVE SIMULATOR ver 1.0''')
    for i in range(167):
        print('*', end='')
    print()
    print('''
...
def Instructions():
    print('''                                                                           INSTRUCTIONS
                                               ...
                                               8. SCORING (FINAL ANSWER BASED)
                                                     RIGHT ANSWER                               = +1000
                                                     EACH VALID RECORD ENTERED IN THE NOTEBOOK  = +100 
                                                     EACH RECORD ENTERED IN THE NOTEBOOK        = +10
                                                     
                                               9. SCORING (TIME BASED)
                                                     IF SOLVED WITHIN 10 MINUTES = +100
                                                     IF SOLVED WITHIN 15 MINUTES = +50
                                                     IF SOLVED WITHIN 20 MINUTES = +25
                                                   NOTE:- Time based scoring will be only applicable when final answer is correct.
...
def ENDGAME(name):
    ...
    print("Time taken to solve the crime:-", minutes, "minutes")
    print()

    if name.lower().strip() in ['mr.henrycrowe', 'henry', 'mr.henry', 'mr.crowe', 'henry crowe', 'henrycrowe',
                                'mr.henry crowe', 'mr. henry crowe', 'mr henry crowe', 'mr. henry', 'mr. crowe',
                                'mr henry', 'mr crowe']:
        print()
    ...
    with open('score_board.csv', 'r') as file:
        ...
        if c == 1:
            print(
                "Hmmm.. Seems like you forgot to enter records in the NOTEBOOK, well that carried points.... Better luck with the score next time....:) ")
        # print(rows)
        ...
        if c1 >= 6:
            score = score + 100
        # print(score)
        print("You entered", c1, "valid records out of 30")
...
Enter ENTER to skip:- """)
    ...
    print("""
                                                            Thanks for playing DETECTIVE SIMULATOR ver 1.0.
...
def GAME():
    ...
    position = [512, 330, 366, 390, 155, 478, 707, 555, 500]

    global date_1
    date_1 = datetime.datetime.today()

    # local_time_1 = global(local_time_1)
    print("Start date & time:-", date_1)
    ...
    for i in position:
        ...
        print()
        print(
            "ADVISORY:- DO NOT FORGET TO ENTER RECORDS IN YOUR NOTEBOOK FROM TIME TO TIME..... THESE RECORDS CARRY POINTS....")
        print()
